import { CommandInteraction, SlashCommandIntegerOption, SlashCommandStringOption } from "discord.js";
...
export const  run = async(bot : CBot, message : CommandInteraction) => {
    try 
    {
        ...
        if(!(typeof nom === "string" && typeof id === "number" && typeof heureDebut === "number" && typeof dateReunion === "string")) return message.reply(typeof nom);
